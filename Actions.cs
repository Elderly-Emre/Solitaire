...
namespace Solitaire
{
    public class Actions
    {
		...
		{
            playingCard.parentGame.cardAudioShot.PlayOneshot(SolitaireMain.cardAudioManager.GetClip("cardslide7"));
		...
		public static IEnumerator pickUpGroup(CardGame cardGame, PlayingCard playingCard, float speed)
		{
            ...
            cardGame.cardAudioShot.PlayOneshot(SolitaireMain.cardAudioManager.GetClip("cardslide7"));
		...
		public static IEnumerator drawCardFromStack(CardGame cardGame, float waitTime, float speed, bool reverse)
        {
            ...
            cardGame.cardAudioShot.PlayOneshot(SolitaireMain.cardAudioManager.GetClip("cardslide4"));
